...
# Constants:
const main_panel_packed = preload("res://addons/ez_saving/objects/main_container/main_container.tscn")
...
func _enter_tree() -> void:
	...
	add_autoload_singleton("EzSaving", "res://addons/ez_saving/objects/plugin_singleton/plugin_singleton_script.gd")
...
func _exit_tree() -> void:
	...
	remove_autoload_singleton("EzSaving")
...
func _get_plugin_icon() -> Texture2D:
	...
	return preload("res://addons/ez_saving/images/tab_icon.svg")
