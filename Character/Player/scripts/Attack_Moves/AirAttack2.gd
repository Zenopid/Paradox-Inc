...
func physics_process(delta):
	...
	if frame == 4:
		...
		air_hitbox_1.hitbox.position = Vector2(entity.position.x + 15.55, entity.position.y + 1.235)
		air_hitbox_2.hitbox.position = Vector2(entity.position.x + 0.327, entity.position.y - 10.528)
