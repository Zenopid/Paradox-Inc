...
func physics_process(delta):
	...
	if frame == 4:
		attack_state.create_hitbox(18.4, 31.47, 5, 1, 180, 3, "Normal", 0, Vector2(15.55, 1.235), Vector2(200, -350), 1)
		attack_state.create_hitbox(16.45, 8.78, 5, 1, 180, 3, "Normal", 0, Vector2(0.327, -10.528), Vector2(200, -350), 1)
